...
class Arcade_phase_1_segmentation():
    ...
    def load_json_files(self):
        ...
        gt_annotation = open('/opt/app/ground-truth/ground_truth_stenosis.json')
                ...
                if list_images_information[i]['image_name']==k['file_name']:
                    for z in gt_annotation['annotations']:
                        if k['file_name'] == z['file_name']:
                            ...
                            temp_f1_scores_for_each_case.append(class_f1_score)
                            
                
                if len(temp_f1_scores_for_each_case)>0:
                    temp_list_class_f1_score.append(max(temp_f1_scores_for_each_case))
